...
MSG=$(jq -c . <<'EOF'
{
  "order_uid": "b563feb7b2b123b6test",
  ...
  "items": [
    {
      "chrt_id": 9934930, "track_number": "WBILMTESTTRACK", "price": 453, "rid": "ab4219087a764ae0btest", "name": "Mascaras",
...
echo "$MSG" | docker compose exec -T kafka \
  kafka-console-producer --bootstrap-server kafka:9092 \
                         --topic orders

echo "Message produced to topic '$TOPIC'."